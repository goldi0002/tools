        ...
        <div className="flex items-center gap-3 mb-4">
          ...
          <div>
            <div className="flex items-center gap-2">
              <h1 className="text-3xl font-semibold text-slate-900 dark:text-white">ToolKit</h1>
              <span className="nav-chip">
                <Sparkles className="h-3.5 w-3.5" />
                Daily ready
              </span>
            </div>
            <p className="text-sm text-slate-500 dark:text-slate-400">Design-forward daily utilities</p>
          </div>
        </div>
        <p className="text-lg text-slate-600 dark:text-slate-400">
          Fast, reliable tools for text, time, and everyday calculations.
        </p>
      </div>
